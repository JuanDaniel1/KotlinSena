...
import com.example.proyectodashboard2.ui.theme.ProyectoDashboardTheme
...
fun MainPage() {
    ...
    // Se usa Scaffold para que se utilice la plantilla donde se coloca un menu desplegable, navegador superior y navegador inferior
    // ademas de un boton flotante
    Scaffold(
