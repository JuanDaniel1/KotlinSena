...
// Login con video de fondo, VideoView declara la funcion para crear el entorno de como se reproduce el video
@Composable
...
fun LoginScreen(navController: NavController, state: Boolean){
    ...
    val showLoginForm = rememberSaveable {
        ...
        Surface(
            ...
            //VideoView invoca la direccion url del video y luego se muestra
