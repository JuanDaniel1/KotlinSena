...
// Este archivo contiene la navegacion y el listado de items con su titulo e icono
enum class PagesScreen(
    ...
    Principal(R.drawable.ic_principal_web, title = "Principal"),
    ...
    Leche(R.drawable.ic_leche, title = "Leche"),
    VerMas(R.drawable.ic_ver_mas, title = "Ver Mas"),


}
//TopBar para scaffold y su diseno
...
//Padding para que se muestre el contenido
@Composable
fun ScaffoldContent(
